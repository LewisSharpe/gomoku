...
namespace Minimax_TPL
{
    ...
    class AIPlayer_TPL : Player_TPL
    {
       ...
       // PUBLIC DECS
        ...
        public List<Tuple<int, int>> getAvailableMoves(GameBoard_TPL<counters> board, Tuple<int, int> positions)
        {
            ...
            for (int x = 1; x <= 15; x++) // for 7x7
                for (int y = 1; y <= 15; y++) // for 7x7
    ...
    */
        ...
        {
            for (int x = 1; x <= ((_SEGM_BOARD == 1) ? 3 : 15); x++) // 1 <=3 for segemented 3x3, or 1 <=7 for original 7x7 board
                       for (int y = 1; y <= ((_SEGM_BOARD == 1) ? 3 : 15); y++) // 1 <=3 for segemented 3x3, or 1 <=7 for original 7x7 board
                {
...
*/
        ...
        */
        public Tuple<int, Tuple<int, int>> ParallelChoice(GameBoard_TPL<counters> board, counters counter, int ply, Tuple<int, int> positions, bool mmax, GameBoard_TPL<int> scoreBoard, int alpha, int beta)
        {
            ...
            int randMoveX = rnd.Next(1, 15); // creates a number between 1 and 7
            int randMoveY = rnd.Next(1, 15); // creates a number between 1 and 7
