          ...
          */
            ...
            if (menuChoice == 1)
            {
                ...
                while (!(char.TryParse(Console.ReadKey().KeyChar.ToString().ToUpper(), out new_counter) && (new_counter == 'W' || new_counter == 'B')))
                    Console.Write("\nInvalid counter. Enter 'W' or 'B': ");
                if (new_counter == 'W')
                {
                    counter = counters.W;
                }
                else if (new_counter == 'B')
                {
                    counter = counters.B;
                }
                else
            ...
            if (menuChoice == 3)
            {
                ...
                Player_TPL xPlayer_TPL = new HumanPlayer_TPL(xName, counters.W);
                Player_TPL oPlayer_TPL = new HumanPlayer_TPL(oName, counters.B);
